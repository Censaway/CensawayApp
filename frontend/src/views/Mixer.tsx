      ...
      <div className="glass flex-1 rounded-3xl p-8 border-t border-white/10 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto pr-1 scrollbar-hide space-y-3">
          ...
          {mixedProfiles.map((m) => {
            ...
            const exitName =
              profiles.find((p) => p.id === m.exit_id)?.name || "Unknown";
              ...
              >
                <div>
                  <div className="flex items-center gap-2">
                    <h3
                      className={`font-bold text-sm ${isActive ? "text-white" : "text-gray-200"}`}
                    >
                      {m.name}
                    </h3>
                    <span className="text-[9px] px-1.5 py-0.5 rounded uppercase font-mono border text-purple-400 border-purple-500/20 bg-purple-500/10">
                      CHAIN
                    </span>
                  </div>
        ...
        <div className="space-y-6 flex-1">
          <div>
            ...
            <input
              ...
              className="w-full h-9 bg-[#0a0a0e] border border-white/10 rounded-lg px-3 text-xs text-white outline-none focus:border-purple-500"
            />
          </div>
